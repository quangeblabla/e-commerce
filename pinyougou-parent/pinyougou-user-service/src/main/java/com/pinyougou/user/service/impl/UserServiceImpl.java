...
public class UserServiceImpl implements UserService {
	...
	public void createSmsCode(final String phone) {
		...
		//验证码存入缓存
		redisTemplate.boundHashOps("phone").put(phone, smsCode);
		//发送activeMq
		jmsTemplate.send(queueSmsDestination, new MessageCreator() {
			...
			public Message createMessage(Session session) throws JMSException {
				...
				message.setString("parm", JSON.toJSONString(map));
				return message;
			}
		});
	}
	...
	public boolean checkSmsCode(String phone, String code) {
		...
		String smsCode = (String) redisTemplate.boundHashOps("phone").get(phone);
		if(smsCode == null) {
			return false;
		}
